...
public class ShopAttackSpeedUpgradeUI : MonoBehaviour
{
    ...
    private int GetCost()
    {
        return baseCost + attackSpeedLevel * costIncreasePerLevel;
    }
    ...
    private void BuyUpgrade()
    {
        ...
        attackSpeedLevel = Mathf.Clamp(attackSpeedLevel, 0, maxAttackSpeedLevel);

        PlayerPrefs.SetInt(TotalGoldKey, totalGold);
        PlayerPrefs.SetInt(AttackSpeedLevelKey, attackSpeedLevel);
        PlayerPrefs.Save();
    ...
    private void RefreshUI()
    {
        ...
        int cost = GetCost();
        bool isMax = attackSpeedLevel >= maxAttackSpeedLevel;
        ...
        if (buttonText != null)
        {
            ...
            {
                buttonText.text =
                    "<b>Prędkość przeładowania</b>" +
                    "<space=1.4em>" +
                    "Lv. " + attackSpeedLevel + "/" + maxAttackSpeedLevel +
                    "<space=1.4em>" +
